...
class Segmentation_Road_UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False, pre_trained = False):
        super(Segmentation_Road_UNet, self).__init__()
    ...
    def load_from_pre_trained(self, folder = "trained_models", filename = "unet_carvana_scale1_epoch5"):
